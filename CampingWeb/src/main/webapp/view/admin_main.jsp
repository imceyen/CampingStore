...
<body class="bg-white text-black font-sans">
    ...
    <main class="max-w-md mx-auto mt-20 px-4">
        ...
        <div class="flex flex-col space-y-4">
            <a href="<%=request.getContextPath() %>/admin_product.go" class="block w-full text-center border border-black px-4 py-2 rounded hover:bg-black hover:text-white transition">
                상품 관리
            </a>
