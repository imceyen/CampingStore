...
<body class="bg-white text-black font-sans">
	...
	<header class="w-full border-b py-4 px-6 relative flex items-center">
		<!-- 로고: 중앙에 위치 -->
		<h1
			class="absolute left-1/2 transform -translate-x-1/2 text-2xl font-bold">
			PacknGo</h1>
	...
	<main class="max-w-7xl mx-auto px-6 py-10">
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
			...
			<div class="border p-4 rounded hover:shadow transition ">
				...
				<div class="flex justify-between items-center mt-3">
					...
					<input type="button" value="자세히 보기"
						onclick="location.href='table1.jsp'"
			...
			<!-- 상품 의자 3개 리스트 -->
			<div class="border p-4 rounded hover:shadow transition ">
				<img src="./image/chair1.jpg" alt="의자1" width="800px" hight="800px"
					class="mb-4">
	...
	<!-- 푸터 -->
	<footer class="border-t p-4 text-center text-sm"> &copy; 2025
		캠핑스토어. 모든 권리 보유. </footer>
</body>
</html>
